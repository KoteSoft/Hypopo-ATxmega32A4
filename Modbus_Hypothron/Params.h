...
typedef enum
{
	...
	MB_O2_SET			=	1,	//Заданная к поддержанию концентрация О2
...
typedef enum
{
	...
	PRESS_TUBE,	//давление воздуха в системе
	NIBP_S,
	NIBP_D,
...
typedef enum
{
	...
	FLOW_DIVIDER,	//Коэффициент усиления усилителя ОРВ		
	K_RIR,		
	K_SPO2,
	B_SPO2,
	RATIO_COEFF,
	...
	PRESS_EXP2,
	PRESS_EXP3,
	PRESS_L1,	//Первый предел давления для проверки наличия тонов Короткова
	PRESS_L2,	//Второй предел давления для проверки наличия тонов Короткова
	PRESS_MIN,
	FLOW_EXP1,
	FLOW_EXP2,
	FLOW_EXP3,
